...
export default function Fusoes(){return <CrudModule titulo="Fusões" subtitulo="Documentação de emendas, fibras de entrada e saída, perdas e registro fotográfico." collectionName="fusoes" fields={fields} cardTitle="nome" cardSubtitle="ceo" icon={Scissors}/>}
